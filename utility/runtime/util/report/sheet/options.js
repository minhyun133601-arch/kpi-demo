(function registerUtilReportSheetOptions(globalScope) {
    ...
    const UTIL_ELECTRIC_ALLOCATION_GROUPS = Object.freeze([
        ...
        Object.freeze({ key: 'demo_boiler_b', label: 'Demo Boiler B', caption: '', sourceIds: Object.freeze(['field_07']) }),
        Object.freeze({ key: 'smallpack', label: 'Process Beta A', caption: '', sourceIds: Object.freeze(['field_12']) }),
        Object.freeze({ key: 'stick', label: 'Process Beta B', caption: '', sourceIds: Object.freeze(['field_13']) }),
