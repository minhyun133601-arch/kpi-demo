    ...
    window.KpiSectionFactories.work = function buildWorkSection() {
        ...
        const teamCategories = [
            ...
            },
            {
                ...
                tint: '#ecfdf5',
                desc: 'Process Beta B 및 Process Beta A 라인별 이력',
                dataKey: 'work_team_calendar_team2',
                view: 'team_calendar',
                viewerMode: 'full-bleed',
                productVisual: 'stick',
                processLabel: 'Process Beta B · Process Beta A',
                processTag: '포장',
                processDesc: 'Process Beta B과 Process Beta A 제품 흐름에 맞춘 Line Gamma 주간 이력입니다.',
                emptyProductionLabel: '품목 미입력',
                emptyWorkLabel: '작업 내역 미입력'
            },
            {
            ...
            },
            {
                ...
                processLabel: '공무환경',
                processTag: '폐수 · 기타',
                processDesc: '폐수, 전체, 기타 작업 중심의 공무환경팀 주간 이력입니다.',
            ...
            categories: [
                {
                    ...
                    secondaryColor: '#1d4ed8',
                    tint: '#eff6ff',
                    desc: 'Line Alpha부터 공무환경팀까지 통합 팀별내역',
                    dataKey: 'work_team_calendar_team1_part1',
                    view: 'team_calendar',
                    viewerMode: 'full-bleed',
                    productVisual: 'dry',
                    processLabel: '통합 보기',
                    processTag: '팀별',
                    processDesc: '모달 상단의 팀 전환 버튼으로 Line Alpha부터 공무환경팀까지 한 화면에서 전환합니다.',
                    emptyProductionLabel: '품목 미입력',
                    emptyWorkLabel: '작업 내역 미입력'
                },
                {
